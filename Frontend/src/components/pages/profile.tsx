    ...
    <div className="w-full">
      <Content>
        <div className="flex w-full gap-3 pt-8">
          <div className=" border-r border-r-indigo-800 pr-6">
            <ImageContainer width="w-96" height="h-96" src={user.profilePic} alt="Avatar" />
          </div>
          <div className="w-full">
            <div className="w-full">
              <div className="w-full border-b border-indigo-800 pb-3">
                <span className=" text-2xl font-bold text-indigo-800">{`${user.firstName} ${user.lastname}`}</span>
              </div>
              <div>
